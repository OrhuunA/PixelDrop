...
echo.
echo Tek dosyalik, konsolsuz .exe olusturuluyor ^(bu birkac dakika surebilir^)...
%PYCMD% -m PyInstaller --onefile --noconsole --name PixelDrop main.py
if errorlevel 1 (
    echo.
